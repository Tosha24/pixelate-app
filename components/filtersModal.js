...
const CustomBackdop = ({ animatedIndex, style }) => {
  const containerAnimatedStyle = useAnimatedStyle(() => {
    // interpolate opacity - it means that when the animatedIndex value is -1, the opacity will be 0, and when the animatedIndex value is 0, the opacity will be 1. The Extrapolation.CLAMP means that the opacity will not go below 0 or above 1.
