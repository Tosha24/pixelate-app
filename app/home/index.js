...
const HomeScreen = () => {
  const { top } = useSafeAreaInsets(); // this means that some devices have a notch at the top of the screen, so we need to add padding to the top of the screen to avoid the notch.. if the device has a notch, the value of top will be greater than 0 and we add 10 to it, else we add 30 to it.. 
    ...
    <View style={[styles.container, { paddingTop }]}>
      ...
      <View style={styles.header}>
        <Pressable onPress={handleScrollUp}>
          <Text style={styles.title}>Pixelate</Text>
        </Pressable>
